...
function DashBoard() {
  ...
  const changeStyle1 = () => {
    if (
      ...
      setStyle(
        "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toogled1"
      );
    } else {
  ...
  const changeStyle = () => {
    if (
      ...
      setStyle(
        "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toogled"
      );
    } else {
      setStyle("navbar-nav bg-gradient-primary sidebar sidebar-dark accordion");
    }
      ...
      <div id="wrapper">
        ...
        <ul className={style} id="accordionSidebar">
          ...
          <li className="nav-item">
            ...
            >
              <div className="bg-white py-2 collapse-inner rounded">
                ...
                <Link to="/adminpage">
                  <a className="collapse-item">AdminPage</a>
                </Link>
                <Link to="/studentdetails">
                  <a className="collapse-item">Add Students</a>
                </Link>
                <Link to="/viewstudents">
                  <a className="collapse-item">View Students</a>
                </Link>
              </div>
            </div>
          </li>
          ...
          <li classNameName="nav-item">
            <a
              classNameName="nav-link collapsed"
              href="#"
              data-toggle="collapse"
                  ...
                  <div className="card shadow mb-4">
                    ...
                    <div className="card-body">
                      ...
                      <div className="progress mb-4">
                        <div
                          className="progress-bar bg-danger a3"
                          role="progressbar"
                        ></div>
                      </div>
                      <h4 className="small font-weight-bold">
